...
render() {
    return (
        ...
        <Link style={{textDecorationLine:"none"}} to={{pathname: "/accept-request/"+this.props.obj.RequestID,state:{Mobile:this.state.Mobile, Cancel:false, HelpTopic:this.props.obj.help}}}>
