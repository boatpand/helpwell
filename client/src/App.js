    ...
    <Router>
      <div className="App">
        <Switch>
          ...
          <Route
            exact
            path="/helperprofile/:mobile"
            component={HelperProfile}
          />
          <Route
            exact
            path="/helperprofile/edit-profile/:mobile"
          ...
          <Route
            exact
            path="/admin/database/victims"
            component={Database_vic}
          />
          <Route
            exact
            path="/admin/database/helpers"
            component={Database_helper}
          />
